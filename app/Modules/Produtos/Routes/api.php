...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/produtos/quantidade', [ProdutosController::class, 'filtrarQuantidadeProdutos']);
    Route::get('/produtos/falta', [ProdutosController::class, 'buscarProdutosEmFalta']);
